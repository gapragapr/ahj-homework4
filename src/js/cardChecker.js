export default class cardChecker{
    ...
    cardCheck(value){
        ...
        const americanExpress = document.querySelector('[data-name="american-express"]')

        if (value.indexOf('4844') === 0 || value.indexOf('4026') === 0 || value.indexOf('417500') === 0 || value.indexOf('4508') === 0 || value.indexOf('4913') === 0 || value.indexOf('4917') === 0){
            visaElectron.classList.add('span-visible')
            return 'visa'
        } else if (value.indexOf('51') === 0 || value.indexOf('52') === 0 || value.indexOf('53') === 0 || value.indexOf('54') === 0 || value.indexOf('55') === 0 || value.indexOf('222100') === 0){
            ...
            return 'ae'
        } else if (value.indexOf('637') === 0 || value.indexOf('638') === 0 || value.indexOf('639') === 0){
